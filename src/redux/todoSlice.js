...
const todoSlice = createSlice({
    name:"todos",
    initialState,
    reducers:{   //here we can declare the reducers function in a normal function pattern or in arrow function
        addTodo(state,action){ //normal function
            state.tasks.push({id:Date(),text:action.payload})
        },
        removeTodo:(state,action)=>{ //arrow function
